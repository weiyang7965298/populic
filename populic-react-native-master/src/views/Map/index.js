            ...
            <TouchableWithoutFeedback onPress={() => this.handlePress(item.id)}>
              <View style={{ flex: 1, flexDirection: 'column' }}>
                ...
                >
                  ...
                  { (item.hot == true) &&
                    <Image
                      style={{marginBottom: -140, width: 300, height: 300, resizeMode: 'contain'}}
                  ...
                  >
                    ...
                    <Lightbox
                      ...
                      renderHeader={close => (
                        ...
                        <View style={{ position: 'absolute', top: 12, right: 15, justifyContent: 'flex-end' }}>
                          { this.props.posts.isPinned ?
                            <View style={{padding: 15, paddingRight: 0, flexDirection: 'row', justifyContent: 'flex-end'}}>
                              <IconCustom
                                name="Pin-Icon"
                                size={45}
                              ...
                              <Text style={{
                                ...
                                textShadowColor: 'black' }}>{item.name}</Text>
                            </View>
                            :
                            <TouchableOpacity onPress={() => this.pinCommunity(item.id)} style={{padding: 15, paddingRight: 0,  flexDirection: 'row', justifyContent: 'flex-end'}}>
                              <IconCustom
